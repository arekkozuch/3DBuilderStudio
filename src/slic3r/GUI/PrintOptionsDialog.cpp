...
wxBoxSizer* PrintOptionsDialog::create_settings_group(wxWindow* parent)
{
  ...
  /*  auto m_line = new wxPanel(this, wxID_ANY, wxDefaultPosition, wxSize(-1, 1), wxTAB_TRAVERSAL);
   ...
   /* sizer->Add(0, 0, 0, wxTOP, FromDIP(12));*/
    ...
    text_save_remote_print_file_to_storage_explain = new Label(parent, _L("Save the printing files initiated from cloud or remote sources to External Storage"));
...
: DPIDialog(parent, wxID_ANY, _L("Printer Parts"), wxDefaultPosition, wxDefaultSize, wxCAPTION | wxCLOSE_BOX)
{
    ...
    m_wiki_link = new HyperLink(single_panel, _L("Wiki Guide")); // MeshForge
    ...
    multiple_wiki_link = new HyperLink(multiple_panel, _L("Wiki Guide")); // MeshForge
