...
static std::map<wxColour, wxColour> gDarkColors{
    {"#009688", "#00675b"}, // rgb(0, 150, 136)    Accent color
    ...
    {"#26A69A", "#008172"}, // rgb(0, 150, 136)    Button Confirm Color hover | Accent Color Hover
    ...
    {"#F0F0F1", "#333337"}, // rgb(240, 240, 241)  Disabled element background // MeshForge Used better background color for dark mode
    ...
    //{"#F0F0F0", "#4C4C54"},
    // MeshForge
    {"#BFE1DE", "#223C3C"}, // rgb(191, 225, 222)  Dropdown checked item background color > Accent color with %25 opacity
    {"#E5F0EE", "#283232"}, // rgb(229, 240, 238)  Combo / Dropdown focused background color > Accent color with %10 opacity
};
