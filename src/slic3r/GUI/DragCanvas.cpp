    ...
    , m_max_shape_pos(wxPoint(0, 0))
{
    ...
    m_background_color = StateColor::darkModeColorFor("#FFFFFF"); // MeshForge
    m_border_color     = StateColor::darkModeColorFor("#DBDBDB"); // MeshForge
...
void DragCanvas::on_erase(wxEraseEvent& event)
{
    ...
    {
        auto& dc = *(event.GetDC());
        dc.SetPen(  m_border_color);     // MeshForge
        dc.SetBrush(m_background_color); // MeshForge
