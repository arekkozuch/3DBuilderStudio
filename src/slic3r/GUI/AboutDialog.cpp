    ...
    : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize)
{
    ...
    this->logo = ScalableBitmap(this, Slic3r::var("MeshForge_192px.png"), wxBITMAP_TYPE_PNG);
        ...
        wxDefaultSize, /*wxCAPTION*/wxDEFAULT_DIALOG_STYLE)
{
    ...
    // logo
    m_logo_bitmap = ScalableBitmap(this, is_dark ? "MeshForge_about_dark" : "MeshForge_about", 125);
    ...
    // version
    {
        ...
        auto          version_string = std::string(MESHFORGE_VERSION); // _L("MeshForge ") + " " + std::string(MESHFORGE_VERSION);
    ...
    wxStaticText *html_text = new wxStaticText(this, wxID_ANY, "Copyright(C) 2026 MeshForge Pte Ltd All Rights Reserved", wxDefaultPosition, wxDefaultSize);
    ...
    m_html = new wxHtmlWindow(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHW_SCROLLBAR_NEVER /*NEVER*/);
      {
          ...
          const auto text = from_u8(
              ...
              "<html>"
              "<body>"
              "<p style=\"text-align:left\"><a style=\"color:#009789\" href=\"https://www.meshforge.com\">https://www.meshforge.com</ a></p>"
              "</body>"
              "</html>")
            ).str());
          m_html->SetPage(text);
