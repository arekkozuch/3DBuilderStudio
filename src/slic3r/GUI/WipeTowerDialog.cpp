...
wxString WipingDialog::BuildTextObjStr(bool multi_language)
{
    ...
    if (multi_language) {
        auto_flush_tip = _L("MeshForge would re-calculate your flushing volumes everytime the filaments color changed or filaments changed. You could disable the auto-calculate in MeshForge > Preferences");
        ...
        auto_flush_tip = "MeshForge would re-calculate your flushing volumes everytime the filaments color changed or filaments changed. You could disable the auto-calculate in MeshForge > Preferences";
