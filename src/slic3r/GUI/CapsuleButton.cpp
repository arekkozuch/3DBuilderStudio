...
static const wxColour BgSelectColor  = wxColour("#E5F0EE"); // MeshForge

static const wxColour TextNormalColor = wxColour("#262E30");
static const wxColour TextSelectColor = wxColour("#262E30"); // MeshForge use same color on selected to improve readability
