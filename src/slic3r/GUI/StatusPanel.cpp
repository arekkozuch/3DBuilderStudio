...
wxPanel *StatusBasePanel::create_bed_control(wxWindow *parent)
{
    ...
    m_bpButton_z_10 = new Button(panel, wxString("10"), "monitor_bed_up", 0, 15); // Fixed icon size 
    ...
    m_bpButton_z_1 = new Button(panel, wxString(" 1"), "monitor_bed_up", 0, 15); // Fixed icon size 
    ...
    m_bpButton_z_down_1 = new Button(panel, wxString(" 1"), "monitor_bed_down", 0, 15); // Fixed icon size 
    ...
    m_bpButton_z_down_10 = new Button(panel, wxString("10"), "monitor_bed_down", 0, 15); // Fixed icon size 
...
wxBoxSizer *StatusBasePanel::create_extruder_control(wxWindow *parent)
{
    ...
    m_bpButton_e_10 = new Button(panel, "", "monitor_extruder_up", 0, 22); // Fixed icon size 
    ...
    m_bpButton_e_down_10 = new Button(panel, "", "monitor_extruder_down", 0, 22); // Fixed icon size 
