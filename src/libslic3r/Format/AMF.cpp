    ...
    case 2:
        ...
        /*else if (m_path[1] == NODE_TYPE_CUSTOM_GCODE) {
            if (strcmp(name, "code") == 0) {
                ...
                {
                    // It means that data was saved in old version (2.2.0 and older) of upstream slicer
                    // read old data ...
...
void AMFParserContext::endElement(const char * /* name */)
{
    ...
    case NODE_TYPE_METADATA:
        /*if ((m_config != nullptr) && strncmp(m_value[0].c_str(), SLIC3R_CONFIG_TYPE, strlen(SLIC3R_CONFIG_TYPE)) == 0) {
            ...
            // parsing 3MFs from before upstream slicer 2.0.0 (which can have duplicated entries in the INI.
