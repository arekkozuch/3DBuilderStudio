    ...
    struct Serializer {
        ...
        void serialize(int facet_idx) {
            ...
            if (split_sides) {
                ...
                // Serialized in reverse order for compatibility with the upstream slicer 2.3.1.
                ...
                if (n >= 3) {
                    ...
                    // Simple case, compatible with the upstream slicer 2.3.1 and older for storing paint on supports and seams.
                    // Store 2 bits of n.
...
// MeshForge: Helper to extract used states from serialized data
