...
"  // Apply bias to z-position to avoid z-fighting\n"
"  eye_position.z += bias;\n"
...
#ifdef __APPLE__
// Use smaller scaling factor for macOS
"const float scaling_factor = 0.75;\n"
#else
// Increase seam marker size to 1.5 for Windows and Linux
